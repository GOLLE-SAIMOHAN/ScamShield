...
dataset_path = os.path.join(DATA_DIR, "Training Dataset.arff")
...
# Save model & scaler
joblib.dump(rf_model, os.path.join(MODELS_DIR, "phishing_rf_model_30feat.pkl"))
joblib.dump(scaler, os.path.join(MODELS_DIR, "scaler_30feat.pkl"))
